...
def save_dataset_samples(dataset, num_samples=5, save_dir='samples', prefix='sample'):
    ...
    for idx, i in enumerate(sample_indices):
        ...
        print(f"img_src shape: {sample['img_src'].shape}")
        print(f"pose_img_src shape: {sample['pose_img_src'][:3].shape}")
        print(f"img_tgt shape: {sample['img_tgt'].shape}")
        print(f"pose_img_tgt shape: {sample['pose_img_tgt'][:3].shape}")
        print(f"img_garment shape: {sample['img_garment'].shape}")
