...
class PisTrainDeepFashion(Dataset):
    ...
    def __getitem__(self, index):
        ...
        #print(f"img_garment shape = {img_garment.shape}")
        #print(f"pose_img_tgt = {pose_img_src.shape}")
...
def visualize_dataset_samples(dataset, num_samples=5, save_path="visualized_samples.png"):
...
visualize_dataset_samples(train_dataset, save_path="C:\\Users\\user\\Desktop\\CFLD\\CFLD\\visualized_samples.png")