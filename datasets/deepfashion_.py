...
# Example usage
train_dataset = PisTrainDeepFashion(root_dir="/home/user/Desktop/CFLD/CFLD/fashion", gt_img_size=(256, 256), pose_img_size=(256, 256), cond_img_size=(256, 256), min_scale=0.8, log_aspect_ratio=(-0.2, 0.2), pred_ratio=[0.1], pred_ratio_var=[0.05], psz=16)
test_dataset = PisTestDeepFashion(root_dir="/home/user/Desktop/CFLD/CFLD/fashion", gt_img_size=(256, 256), pose_img_size=(256, 256), cond_img_size=(256, 256), test_img_size=(256, 256))
